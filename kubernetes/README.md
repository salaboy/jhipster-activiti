...
```
$ docker image tag gateway salaboy/gateway
$ docker push salaboy/gateway
$ docker image tag invoice salaboy/invoice
$ docker push salaboy/invoice
$ docker image tag review salaboy/review
$ docker push salaboy/review
```
